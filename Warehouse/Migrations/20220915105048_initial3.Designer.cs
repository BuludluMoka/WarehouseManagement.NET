...
namespace Warehouse.Migrations
{
    ...
    [Migration("20220915105048_initial3")]
            ...
            modelBuilder.Entity("Warehouse.Data.Models.Transacction", b =>
                {
                    ...
                    b.HasOne("Warehouse.Data.Models.Ambar", "Warehouses2")
                        .WithMany("Transacctions2")
                        .HasForeignKey("receiver_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Warehouse.Data.Models.Ambar", "Warehouses1")
                        .WithMany("Transacctions")
                        .HasForeignKey("sender_id");

                    b.Navigation("Product");

                    b.Navigation("Warehouses1");

                    b.Navigation("Warehouses2");
                });
